...
class WallFollow:
	...
	drive_msg.drive.speed = 2 # - (abs(angle) / 2.35619 * 1) #6 - (abs(angle) / 2.35619 * 5)
	angle_degrees = angle * 180 / math.pi
	if angle_degrees > -10 and angle_degrees < 10:
		drive_msg.drive.speed = 5 #7
		#rospy.loginfo("drive straight")
	elif angle_degrees > 10 and angle_degrees < 20 or angle_degrees > -20 and angle_degrees < -10:
